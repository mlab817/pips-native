...
import {Box, Center, Heading, HStack, Icon, IconButton, Image, Text, VStack} from "native-base";
...
export default function SettingScreen() {
	return (
		<Box flex={1}>
			<Heading bg={Colors.secondary} px={2} pt={3} color={Colors.white}>Settings</Heading>
